 ...
 //the declarations must be here, not global 0,0 -automatic range and #bins, otherwise 100 bins
  TPlotDefinitions Event_plots_FXT{
    ...
    TPlotDef{"Evt.ZDCx","ZDC coincidence rate","f[hz]",0,80,"ZDC"}, 
    TPlotDef{"Evt.BBCx","BBC coincidence rate","f[Hz]",0,30000,"BBC"},
    TPlotDef{"Evt.nBTOFMatch","Num of TOF matched track","#TOF matched",0,500,"TOFmatch"},
    TPlotDef{"Evt.refMult","RefMult ","RefMult",0,300,"refMult"},
    TPlotDef{"Evt.gRefMult","gRefMult","gRefMult",0,300,"gRefMult"},
