...
void StKFParticleInterface::FixedTarget()                               {fIsFixedTarget = true; GetKFParticleFinder()->SetMaxLCut(1e9);}
...
//       }
  ...
  //cout<<"Petr -test nPartSaved="<<nPartSaved<<" nUsedTracks="<<nUsedTracks<<endl;
  ...
  //   if( fCleanLowPVTrackEvents && ( (nUsedTracks - nPrimary) > (50. + 0.75*nPrimary) ) ) return 0;
    ...
    { //collider
      if( fCleanLowPVTrackEvents && primaryVertex.GetR() > 3.5 ){
       cout<< "test primaryVertex.GetR()>3.5 failed R="<<primaryVertex.GetR()<<endl;
       return 0;
     }
...
{  
  ...
  cout<<" +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"<<endl;
  cout<<" +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"<<endl;
  cout<<" ++++++++++++++++BIG WARNING  BIG WARNING BIG WARNING  +++++++++++++++++++++++++++"<<endl;
  cout<<" +++++++++++++StKFParticleInterface::ProcessEvent(StMuDst* muDst,...)   ++++++++++"<<endl;
  cout<<" +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"<<endl;
  cout<<" ++++++++    There are no McTracks under standard libraries          ++++++++++++++"<<endl;
  cout<<" +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"<<endl;
  cout<<" +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"<<endl;
