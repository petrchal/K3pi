...
*/
void muAnalysis(Int_t N = 1000,
  char isSim=false, char noPID=false,
  const Char_t *input = "/gpfs01/star/subsys-tpc/fisyak/Pico/2020/TFG21b/RF/9p8GeV_fixedTarget/032/hlt_21032016_10_01_000.MuDst.root", 
